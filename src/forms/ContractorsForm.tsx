...
import translations from "./contractorsform-translations.ts";
      ...
      {formFields.map((field) => (
        <div key={field.id}>
          ...
          <input
            ...
            onChange={(e) =>
              handleInputChange(field.id, "companyName", e.target.value)
            }
          />
          <input
            type="text"
            ...
            value={field.street}
            onChange={(e) =>
              handleInputChange(field.id, "street", e.target.value)
            }
          />
          <input
            type="text"
            ...
            onChange={(e) =>
              handleInputChange(field.id, "buildingNumber", e.target.value)
            }
          />
          <input
            type="text"
            ...
            onChange={(e) =>
              handleInputChange(field.id, "flatNumber", e.target.value)
            }
          />
          <input
            type="text"
          ...
          <input
            ...
            value={field.country}
            onChange={(e) =>
              handleInputChange(field.id, "country", e.target.value)
            }
          />
          <input
            type="text"
